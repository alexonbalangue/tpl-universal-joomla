...
$docs->addScriptDeclaration('
{
	...
	"currenciesAccepted" : "€",
	"paymentAccepted" : "Espèce, Chèque bancaire, Virement bancaire, Paypal, Stripe",
	"priceRange" : "€€",
	"hasMap" : "https://www.google.com/maps/place/Detect+Pro/@48.875545,2.3705113,17z/data=!3m1!4b1!4m5!3m4!1s0x0:0xf1400ad6c97ef933!8m2!3d48.875545!4d2.3727"
}', 'application/ld+json');
...
$docs->addCustomTag('<link rel="canonical" href="'.JURI::current().'">'); 
		...
		if(!empty('20161101')){
			$docs->setMetaData('Date-Creation-yyyymmdd', '20161101');
			$docs->setMetaData('DC.created', '20161101');
			$docs->setMetaData('dcterms.created ', '20161101');
			$docs->setMetaData( 'creation_date', '20161101' );
		}
			$docs->setMetaData('Date-Revision-yyyymmdd', date('Y').date('m').date('d'));
